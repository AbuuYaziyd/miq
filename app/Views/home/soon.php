			...
			<div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
				<div class="card border-grey border-lighten-3 m-0">
					<div class="card-header border-0">
						...
						<h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span><?= lang('app.soon') ?></span>
						</h6>
					</div>
					<div class="card-body text-center">
						<h1><?= lang('app.soon') ?></h1>
						<h4><?= lang('app.disturb') ?></h4>
						<div class="mt-2"><i class="la la-cog spinner font-large-4"></i></div>
					</div>
