        ...
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    ...
                    <hr>
                    <?= form_open('teacher/update') ?>
                    <div class="row mx-1">
                        <fieldset class="col-md-3 mb-1">
                            <label><b><?= lang('app.username') ?>:</b></label>
                            <input type="text" class="form-control" value="<?= $user['username'] ?>" readonly>
                        </fieldset>
                        <fieldset class="col-md-4 mb-1">
                            <label><b><?= lang('app.website') ?>:</b></label>
                            <select name="web" class="custom-select">
                                <option value="showOnWeb" <?= $user['web'] == 'showOnWeb' ? 'selected' : '' ?>><?= lang('app.showOnWeb') ?></option>
                                <option value="dontShow" <?= $user['web'] == 'dontShow' ? 'selected' : '' ?>><?= lang('app.dontShow') ?></option>
                            </select>
                        </fieldset>
                        <fieldset class="col-md-5 mb-1">
                        ...
                        <div class="col-md-6">
                            <label><b><?= lang('app.academicLevel') ?></b></label>
                            <fieldset class="form-group">
                                <select class="custom-select" name="level">
                                    <option selected disabled><?= lang('app.choose') ?></option>
                                    <option value="mutawassitwa" <?= $user['level'] == 'mutawassitwa' ? 'selected' : '' ?>><?= lang('app.mutawassitwa') ?></option>
                                    <option value="thanawi" <?= $user['level'] == 'thanawi' ? 'selected' : '' ?>><?= lang('app.thanawi') ?></option>
                                    <option value="degree" <?= $user['level'] == 'degree' ? 'selected' : '' ?>><?= lang('app.degree') ?></option>
                                    <option value="masters" <?= $user['level'] == 'masters' ? 'selected' : '' ?>><?= lang('app.masters') ?></option>
                                    <option value="phD" <?= $user['level'] == 'phD' ? 'selected' : '' ?>><?= lang('app.phD') ?></option>
                                </select>
                            </fieldset>
                        </div>
                        <fieldset class="col-md-6 mb-1">
                        ...
                        <fieldset class="col-md-4 mb-1">
                            ...
                            <input type="text" class="form-control" name="facebook" value="<?= $user['facebook'] ?>" placeholder="<?= lang('app.facebook') ?>">
                        </fieldset>
                        <fieldset class="col-md-4 mb-1">
                            <label><b><?= lang('app.insta') ?>:</b></label>
                            <input type="text" class="form-control" name="insta" value="<?= $user['insta'] ?>" placeholder="<?= lang('app.insta') ?>">
                        </fieldset>
                        <fieldset class="col-md-4 mb-1">
                            <label><b><?= lang('app.twitter') ?>:</b></label>
                            <input type="text" class="form-control" name="twitter" value="<?= $user['twitter'] ?>" placeholder="<?= lang('app.twitter') ?>">
                        </fieldset>
